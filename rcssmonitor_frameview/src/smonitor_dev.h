...
class VisualPlayer
    ...
    VisualCircle2d body_margin_foul_charged;
...
public:
    ...
    */
    ...
    void set_foul_charged( bool flag )
      {
          foul_charged = flag;
      }

    void set_yellow_card( bool flag )
      {
          yellow_card = flag;
          if ( flag ) label.set_color( c_yellow );
      }

    void set_red_card( bool flag )
      {
          red_card = flag;
          if ( flag ) label.set_color( c_red );
      }
    ...
    bool has_yellow_card() const { return yellow_card; }
    bool has_red_card() const { return red_card; }
};
